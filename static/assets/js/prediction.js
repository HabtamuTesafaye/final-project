document.addEventListener('DOMContentLoaded', function () {
    ...
    uploadBtn.addEventListener('click', async () => {
        ...
        try {
            ...
            loading.innerText = 'Failed to upload file and start prediction.';
            loading.style.display = 'block';  // Ensure loading is visible
        }
    });
    ...
    async function startBackgroundProcess() {
        try {
            ...
            loading.innerText = 'Failed to start background process.';
        }
    }
    ...
    async function pollForPredictions() {
        try {
            ...
            loading.innerText = 'Failed to fetch future predictions.';
            setButtonsState(false); 
        }
    }
    ...
    async function renderChart(indicatorFuturePredictions) {
        try {
            ...
            loading.innerText = 'Failed to render chart.';
        }
    }
