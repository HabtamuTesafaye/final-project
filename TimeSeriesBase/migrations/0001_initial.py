    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('value_entrance_type', models.CharField(blank=True, choices=[('1month', '1 Month'), ('2month', '2 Month'), ('3month', '3 Month'), ('4month', '4 Month'), ('5month', '5 Month'), ('6month', '6 Month'), ('7month', '7 Month'), ('8month', '8 Month'), ('9month', '9 Month'), ('10month', '10 Month'), ('11month', '11 Month')], max_length=15, null=True)),
                ('is_deleted', models.BooleanField(default=False)),
